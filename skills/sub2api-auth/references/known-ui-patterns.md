...
- `source`: artifact `codex-clipboard-85456eba-d2dd-486e-9c02-863d00ebc6c3.png`; source system `链动小铺 order-detail page`; order `LD26072731CVWM`
- `as_of`: `2026-07-28`
...
- `redaction_note`: original image contains live account identifiers/instructions and is not committed; only provenance and hash are recorded
- `source_sha256`: `3aca992604ab571a012576ea7ce4816aa543109209ab8ce856e383a385fbe184`
