...
- Local admin URL used successfully: the configured `SUB2API_ADMIN_URL` (value in `.env`, gitignored)
- Health check: `curl -sS -m 5 "$SUB2API_ADMIN_BASE/health"`
...
env['SUB2API_ADMIN_URL'] = process.env.SUB2API_ADMIN_URL // from .env (gitignored)
